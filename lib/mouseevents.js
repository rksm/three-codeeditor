;(function(exports) {
  ...
  function processScrollbarMouseEvent(THREExDOMEvents, codeEditor, clickState, evt3D) {
    ...
    var localBrowserPos = convertToLocalBrowserCoords(evt3D.intersect, codeEditor),
        hit = codeEditor.scrollbar.left <= localBrowserPos.x && localBrowserPos.x <= codeEditor.scrollbar.left + codeEditor.scrollbar.width
