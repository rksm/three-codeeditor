            ...
            return {
              ...
              completer: compl[0] !== "[" ? null : {
                insertMatch: function(ed, completion) {
                  ...
                  var rangeBefore = {start: {row: pos.row, column: pos.column-1}, end: pos};
                  var charBefore = ed.session.getTextRange(rangeBefore);
                  if (charBefore === ".") ed.session.replace(rangeBefore, "");
